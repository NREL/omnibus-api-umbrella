...
override :bundler, version: '1.7.14' # Hold at 1.7 due to current issues with 1.8 and rails-assets gems: https://github.com/rails-assets/rails-assets/issues/226
override :dnsmasq, version: '2.72'
override :elasticsearch, version: '1.5.1'
override :elasticsearch_bigdesk, version: 'v2.5.0'
override :elasticsearch_head, version: 'f3a85b25364a9bc6f752a7e07c9f71e9e36d5bd1'
override :elasticsearch_hq, version: '603ae9ed1b63ad6ffd0f81fb8ebf9f4f820ea360'
override :mongodb, version: '2.6.9'
override :nginx, version: '1.7.10'
override :nginx_echo, version: 'v0.57'
override :nginx_headers_more, version: 'v0.26'
override :nginx_txid, version: 'f1c197cb9c42e364a87fbb28d5508e486592ca42'
override :nodejs, version: '0.10.38'
override :openssl, version: '1.0.1m'
override :python, version: '2.7.7'
override :redis, version: '2.8.19'
override :ruby, version: '2.1.6' # Hold at 2.1 as long as we're on Rails 3.2: https://github.com/rails/rails/pull/18160
